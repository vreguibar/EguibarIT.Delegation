        ...
        protected override void ProcessRecord()
        {
            ...
            if (
                EguibarIT.Delegation.Constructors.AclCon6.AclConstructor6(
                    ...
                    System.Guid.Empty,
                    ActiveDirectorySecurityInheritance.Descendents,
                    EguibarIT.Delegation.GUIDs.ConvertNameToSchemaGUID("nTDSDSA"),
                    _removerule
                ))
            {
                valueFromConstructor++;
            ...
            if (
                EguibarIT.Delegation.Constructors.AclCon6.AclConstructor6(
                    ...
                    System.Guid.Empty,
                    ActiveDirectorySecurityInheritance.Descendents,
                    EguibarIT.Delegation.GUIDs.ConvertNameToSchemaGUID("server"),
                    _removerule
                ))
            {
                valueFromConstructor++;
            ...
            if (
                EguibarIT.Delegation.Constructors.AclCon6.AclConstructor6(
                    ...
                    System.Guid.Empty,
                    ActiveDirectorySecurityInheritance.Descendents,
                    EguibarIT.Delegation.GUIDs.ConvertNameToSchemaGUID("nTDSConnection"),
                    _removerule
                ))
            {
                valueFromConstructor++;
