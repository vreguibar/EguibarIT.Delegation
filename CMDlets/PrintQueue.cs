...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    /// </summary>
    /// <para type="link" uri="(http://EguibarIT.eu)">[Eguibar Information Technology S.L. web site]</para>
    [Cmdlet(VerbsCommon.Rename, "AdAclPrintQueue", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class RenamePrintQueue : PSCmdlet
    {
        #region Parameters definition
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                WriteVerbose("Delegate rename Print Queue object class completed succesfully.");
            }

            if (valueFromConstructor != 6)
            {
                WriteWarning("Something went wrong when delegating rename Print Queue object class");
            }
        }
    ...
    /// </summary>
    /// <para type="link" uri="(http://EguibarIT.eu)">[Eguibar Information Technology S.L. web site]</para>
    [Cmdlet(VerbsCommon.Set, "AdAclChangePrintQueue", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class ChangePrintQueue : PSCmdlet
    {
        #region Parameters definition
        ...
        protected override void ProcessRecord()
        {
            ...
            if (valueFromConstructor == 2)
            {
                WriteVerbose("Delegate change Print Queue object class completed succesfully.");
            }

            if (valueFromConstructor != 2)
            {
                WriteWarning("Something went wrong when delegating change Print Queue object class");
            }
        }
    ...
    } //END class ChangePrintQueue
} // END namespace EguibarIT.Delegation.PrintQueue