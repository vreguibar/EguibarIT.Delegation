...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "AdAclUserGeneralInfo", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class UserGeneralInfo : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            --------------------------------------------------------
             ...
             ActiveDirectoryRightst : ReadProperty, WriteProperty
                  AccessControlType : Allow
                         ObjectType : General Information [ExtendedRight]
            ...
            {
                WriteVerbose("Delegate modify User object general information set completed succesfully.");
            }

            if (valueFromConstructor != 2)
            {
                WriteWarning("Something went wrong when delegating modify User object general information set");
            }
        }
