...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "AdAclEnableDisableUser", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class EnableDisableUser : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                WriteVerbose("Delegate enable/disable User object class completed succesfully.");
            }

            if (valueFromConstructor != 2)
            {
                WriteWarning("Something went wrong when delegating enable/disable User object class");
            }
        }
