...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "AdAclUnlockUser", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class UnlockUser : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                WriteVerbose("Delegate unlock User object class completed succesfully.");
            }

            if (valueFromConstructor != 2)
            {
                WriteWarning("Something went wrong when delegating unlock User object class");
            }
        }
