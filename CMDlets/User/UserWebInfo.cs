...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "AdAclUserWebInfo", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class UserWebInfo : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                WriteVerbose("Delegate modify User object web information set completed succesfully.");
            }

            if (valueFromConstructor != 2)
            {
                WriteWarning("Something went wrong when delegating modify User object web information set");
            }
        }
