...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "AdAclUserEmailInfo", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class UserEmailInfo : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            --------------------------------------------------------
             ...
             ActiveDirectoryRightst : ReadProperty, WriteProperty
                  AccessControlType : Allow
                         ObjectType : Phone and Mail Options [ExtendedRight]
            ...
            if (
                EguibarIT.Delegation.Constructors.AclCon6.AclConstructor6(
                    ...
                    AccessControlType.Allow,
                    EguibarIT.Delegation.GUIDs.ConvertNameToSchemaGUID("Phone and Mail Options"),
            ...
            {
                WriteVerbose("Delegate modify User object phone and mail options completed succesfully.");
            }

            if (valueFromConstructor != 2)
            {
                WriteWarning("Something went wrong when delegating modify User object phone and mail options");
            }
        }
