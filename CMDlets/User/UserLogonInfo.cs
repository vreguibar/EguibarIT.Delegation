...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "AdAclUserLogonInfo", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class UserLogonInfo : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            --------------------------------------------------------
             ...
             ActiveDirectoryRightst : ReadProperty, WriteProperty
                  AccessControlType : Allow
                         ObjectType : Logon Information [ExtendedRight]
            ...
            {
                WriteVerbose("Delegate modify User object logon information set completed succesfully.");
            }

            if (valueFromConstructor != 2)
            {
                WriteWarning("Something went wrong when delegating modify User object logon information set");
            }
        }
