...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "AdAclUserAccountRestriction", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class UserAccountRestriction : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                WriteVerbose("Delegate modify User object account restrictions completed succesfully.");
            }

            if (valueFromConstructor != 2)
            {
                WriteWarning("Something went wrong when delegating modify User object account restrictions");
            }
        }
    ...
    } //END class UserAccountRestriction
}