...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Rename, "AdAclUser", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class RenameUser : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                WriteVerbose("Delegate rename User object class completed succesfully.");
            }

            if (valueFromConstructor != 6)
            {
                WriteWarning("Something went wrong when delegating rename User object class");
            }
        }
