...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "AdAclUserPersonalInfo", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class UserPersonalInfo : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                WriteVerbose("Delegate modify User object personal information set completed succesfully.");
            }

            if (valueFromConstructor != 2)
            {
                WriteWarning("Something went wrong when delegating modify User object personal information set");
            }
        }
