...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "AdAclMngPrivilegedGroups", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class AdAclMngPrivilegedGroups : PSCmdlet
    {
    ...
    #>
            ...
            {
                WriteVerbose("Delegate Management of Privileged Groups Rights completed succesfully.");
            }

            if (valueFromConstructor != 2)
            {
                WriteWarning("Something went wrong when delegating Management of Privileged Groups Rights.");
            }
        }
    ...
    } //END class MngPrivilegedGroups
} // END namespace EguibarIT.Delegation.PrivilegedGroups