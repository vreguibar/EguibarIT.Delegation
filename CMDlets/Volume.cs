...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "AdAclCreateDeleteVolume", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class CreateDeleteVolume : PSCmdlet
    {
...
} // END namespace EguibarIT.Delegation.Volume