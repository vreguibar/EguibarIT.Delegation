...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "CreateDeleteInetOrgPerson", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class CreateDeleteInetOrgPerson : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                WriteVerbose("Delegate Create/Delete InetOrg object class completed succesfully.");
            }

            if (valueFromConstructor != 3)
            {
                WriteWarning("Something went wrong when delegating Create/Delete InetOrg object class");
            }
        }
