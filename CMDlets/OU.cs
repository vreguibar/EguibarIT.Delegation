...
namespace EguibarIT.Delegation.CMDlets
{
    ...
    [Cmdlet(VerbsCommon.Set, "AdAclCreateDeleteOU", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class CreateDeleteOU : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (
                EguibarIT.Delegation.Constructors.AclCon6.AclConstructor6(
                    ...
                    ActiveDirectoryRights.CreateChild,
                    AccessControlType.Allow,
                    EguibarIT.Delegation.GUIDs.ConvertNameToSchemaGUID("account"),
                    ActiveDirectorySecurityInheritance.Descendents,
                    EguibarIT.Delegation.GUIDs.ConvertNameToSchemaGUID("organizationalUnit"),
                    _removerule
                ))
            ...
            {
                WriteVerbose("Delegate Create/Delete OU object class completed succesfully.");
            }

            if (valueFromConstructor != 6)
            {
                WriteWarning("Something went wrong when delegating Create/Delete OU object class");
            }
        }
    ...
    /// </summary>
    /// <para type="link" uri="(http://EguibarIT.eu)">[Eguibar Information Technology S.L. web site]</para>
    [Cmdlet(VerbsCommon.Set, "AdAclChangeOU", ConfirmImpact = ConfirmImpact.Medium)]
    [OutputType(typeof(int))]
    public class ChangeOU : PSCmdlet
    {
        #region Parameters definition
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                WriteVerbose("Delegate change OU object class completed succesfully.");
            }

            if (valueFromConstructor != 2)
            {
                WriteWarning("Something went wrong when delegating change OU object class");
            }
        }
    ...
    } //END class AdAclChangeOU
} // END namespace EguibarIT.Delegation.OU